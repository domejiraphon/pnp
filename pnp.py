...
class PNP(nn.Module):
    ...
    def get_data(self):
        ...
        logger.info(f"Load latents from this: {latents_path}")
...
def main():
    ...
    pnp = PNP(config)
    handles = [(50, 170), (50, 260), (355, 175), (355, 260)]
    targets = [(50, 70), (50, 160), (355, 175), (355, 260)]
    pnp.run_pnp(handles, targets)
